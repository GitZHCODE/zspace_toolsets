...
set start=%time%
start /d "%programfiles(x86)%\Microsoft Visual Studio\2019\Professional\MSBuild\Current\Bin" /wait MSBuild.exe %cd%\zSpace_toolsets.sln /t:zSpace_Toolsets /p:Configuration="Release" /p:Platform="x64"
set end=%time%
