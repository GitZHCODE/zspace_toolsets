...
namespace zSpace
{
	...
	ZSPACE_TOOLSETS_INLINE void EXT_SetFromJSON(zTsSDFSlicer*& slicer, char* path, int blockID, bool& isDeckBlock)
	{
	...
	ZSPACE_TOOLSETS_INLINE int EXT_computePrintBlocks(zTsSDFSlicer*& slicer, float printLayerWidth, float raftLayerWidth, bool allSDFLayers, int& numSDFLayers, int SDFFunc_Num, int SDFFunc_NumSmooth, float neopreneOffsetMin, float neopreneOffsetMax, float heightDomainMin, float heightDomainMax, float printPlaneStep, bool compFrames, bool compSDF)
	{
	...
	ZSPACE_TOOLSETS_INLINE void EXT_computeSDFLayer(zTsSDFSlicer*& slicer, int SDFLayerNumber, float printLayerWidth, float raftLayerWidth,  int SDFFunc_Num, int SDFFunc_NumSmooth, float neopreneOffsetMin, float neopreneOffsetMax, float heightDomainMin, float heightDomainMax, float printPlaneStep, bool compFrames)
	{
	...
	ZSPACE_TOOLSETS_INLINE void EXT_duplicateSlicer(zTsSDFSlicer* inSlicer, zTsSDFSlicer*& outSlicer)
	{
	...
	ZSPACE_TOOLSETS_INLINE int EXT_getTrimGraph(zTsSDFSlicer* slicer, zObjGraphPointerArray*& graphs, int& Count)
	{
		if (!slicer)
		{
			return 0;
	...
	ZSPACE_TOOLSETS_INLINE void EXT_getGraphSequence(zObjGraph* graph, int* outSequence)//the size of the area = the number of vertices + 1
	{
		zIntArray seq;
	...
	ZSPACE_TOOLSETS_INLINE void EXT_ExportJSON(zTsSDFSlicer* slicer, char* fileCurrent, int fileCount, char* fileNew, int newCount,  char* fileName, int nameCount, float printLayerWidth, float raftLayerWidth)
	{
	...
	ZSPACE_TOOLSETS_INLINE void EXT_CheckFolder(char* folderDirectoryChar, float neopreneOffsetMin, float neopreneOffsetMax, float heightDomainMin, float heightDomainMax)
	{
