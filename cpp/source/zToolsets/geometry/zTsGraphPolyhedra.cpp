...
namespace zSpace
{
	...
	ZSPACE_INLINE void zTsGraphPolyhedra::setFormGraphFromFile(string& _path, zFileTpye _type, bool _staticGeom)
	{
		// create graph
	...
	ZSPACE_INLINE void zTsGraphPolyhedra::setFormGraphFromMesh(zObjMesh& _inMeshObj, zVector& _verticalForce)
	{
	...
	ZSPACE_INLINE zObjGraph* zTsGraphPolyhedra::getRawFormGraph()
	{
		return &o_formGraph;
	}

	ZSPACE_INLINE zObjMeshPointerArray zTsGraphPolyhedra::getRawForceMeshes(int& numMeshes)
	{
	...
	ZSPACE_INLINE void zTsGraphPolyhedra::createForceMeshes()
	{
		int activeNodes = 0;
		double tol = 0.002;
	...
	ZSPACE_INLINE bool zTsGraphPolyhedra::equilibrium(bool& compTargets, float formWeight, float areaScale,  double dT, zIntergrationType type, float minMax_formEdge, float minMax_forceEdge, int numIterations, double angleTolerance, double areaTolerance, bool printInfo)
	{
		if (compTargets)
		{
			printf("\n compute targets ");
	...
	ZSPACE_INLINE void zTsGraphPolyhedra::createForceMesh(zItGraphVertex& _graphVertex, double _tol)
	{
	...
	ZSPACE_INLINE void zTsGraphPolyhedra::computeTargets(float formWeight, float areaScale)
	{
		zFnGraph fnGraph(o_formGraph);
	...
	ZSPACE_INLINE void zTsGraphPolyhedra::updateFormDiagram(float minmax_Edge, float dT, zIntergrationType type, int numIterations)
	{
	...
	ZSPACE_INLINE void zTsGraphPolyhedra::updateForceDiagram(float minmax_Edge, float dT, zIntergrationType type, int numIterations)
	{
		// create particles
	...
	ZSPACE_INLINE bool zTsGraphPolyhedra::checkDeviations(zDomainDouble& angleDeviation, double& angleTolerance, zDomainDouble& areaDeviation, double& areaTolerance, bool& printInfo)
	{
		bool out = true;
	...
	ZSPACE_INLINE void zTsGraphPolyhedra::colorGraphEdges()
	{
		zFnGraph fnGraph(o_formGraph);
